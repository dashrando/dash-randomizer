    ...
    <Wrapper>
      <div style={{ maxWidth: '620px', margin: '0 auto' }}>
        <article className={styles.article}>
          ...
          <ul>
            <li>New features (such as area randomization and boss shuffle)</li>
            <li>Logic changes</li>
